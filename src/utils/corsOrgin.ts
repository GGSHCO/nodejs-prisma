...
const corsOrigin =
  process.env.NODE_ENV === 'prod'
    ? ['https://speedyourfin.ai', 'https://www.speedyourfin.ai' , 'https://syf.speedyourfin.ai','http://localhost:3080', 'http://desktop-dssus3g:82', 'https://syftestenv.speedyourfin.in']
